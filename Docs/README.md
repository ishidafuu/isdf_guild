...
- `framework/README.md`: 世界観差し替え型フレームワーク設計の案内
...
1. まず `構想.md` から全体像を確認する
2. 中世ファンタジー世界の正本は `plan/` 配下を参照する
3. 世界観差し替え型の共通設計は `framework/` 配下を参照する
4. 変更対象の章ファイルに直接追記する
5. 決定事項は対応する changelog に日付つきで残す
